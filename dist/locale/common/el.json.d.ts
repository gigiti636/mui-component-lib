declare const _default: {
  ...
  "cancel_confirmation": "Αν προχωρήσετε θα χάσετε όλη την πρόοδό σας. Είστε βέβαιοι ότι θέλετε να ακυρώσετε τη διαδικασία; ",
  "choose_completed_excel_file": "Βήμα 1: Επιλέξτε το τελικό αρχείο excel στη μορφή που παρέχεται. ",
  "expired": "Έληξε",
  ...
  "pending_page": "Έχουμε στείλει αίτημα πληρωμής στο email σας.\nΗ παραγγελία σας θα ολοκληρωθεί μόλις ληφθεί η πληρωμή."
}
;
